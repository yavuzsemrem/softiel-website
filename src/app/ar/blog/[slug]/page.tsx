  ...
  loading: () => (
    <div className="min-h-screen bg-gradient-to-b from-slate-700 via-slate-800 to-black flex items-center justify-center">
      <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/10">
        ...
        <h2 className="text-2xl font-bold text-white mb-4">تحميل المدونة</h2>
        <p className="text-neutral-400 mb-6">يرجى الانتظار...</p>
      </div>
    </div>
  )
})
...
export async function generateMetadata({ params }: BlogDetailPageProps): Promise<Metadata> {
  ...
  return {
    title: 'Blog | Softiel',
    description: 'مقالات مدونة Softiel - تصميم الويب وتحسين محركات البحث والتسويق الرقمي',
    openGraph: {
      title: 'Softiel Blog',
      description: 'مقالات مدونة Softiel',
      type: 'article',
    },
    twitter: {
