...
import { Briefcase, Star, Users, ArrowRight, Award, Target, Zap, CheckCircle, Sparkles, Shield, Globe, Code, Palette, Search, Clock, Headphones, MessageCircle } from "lucide-react"
    ...
    <section className="relative bg-gradient-to-b from-slate-900 via-slate-850 to-slate-900 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/5 opacity-5">
          <Users className="h-14 w-14 text-cyan-400" />
        </div>
        ...
        <div className="absolute top-3/4 left-1/4 opacity-5">
          <Globe className="h-11 w-11 text-cyan-50" />
        </div>
        ...
        <div className="absolute top-1/3 left-1/12 opacity-5">
          <Globe className="h-9 w-9 text-cyan-100" />
        </div>
        ...
        <div className="absolute top-1/6 left-1/3 opacity-5">
          <Briefcase className="h-6 w-6 text-cyan-50" />
        </div>
        <div className="absolute top-1/8 left-1/2 opacity-5">
          <Star className="h-7 w-7 text-blue-50" />
        </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t('references.stats.completedProjects')}</h3>
            <p className="text-blue-400 font-medium mb-1 text-lg">{t('references.stats.completedProjectsDesc')}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t('references.stats.happyClients')}</h3>
            <p className="text-blue-400 font-medium mb-1 text-lg">{t('references.stats.happyClientsDesc')}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">{t('references.stats.satisfaction')}</h3>
            <p className="text-blue-400 font-medium mb-1 text-lg">{t('references.stats.satisfactionDesc')}</p>
          </motion.div>
        </div>
      </div>
    </section>
