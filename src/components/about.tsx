        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center space-x-2 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-full px-4 py-2 mb-6"
            >
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl lg:text-4xl font-display font-bold text-neutral-900 dark:text-white mb-6"
            >
              Dijital Dünyada{" "}
            ...
            >
              <Link href="/hakkimizda">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center space-x-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
                >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="group flex items-center space-x-2 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white px-6 py-3 rounded-lg font-semibold border-2 border-neutral-200 dark:border-neutral-700 hover:border-primary-500 dark:hover:border-primary-400 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
            ...
            <div className="relative">
              ...
              <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 shadow-2xl border border-neutral-200 dark:border-neutral-700">
                ...
                <div className="space-y-3">
                  ...
                  <div className="w-full bg-neutral-200 dark:bg-neutral-600 rounded-full h-2">
                    <div className="bg-gradient-to-r from-secondary-500 to-secondary-600 h-2 rounded-full" style={{ width: '90%' }}></div>
                  </div>
                  ...
                  <div className="w-full bg-neutral-200 dark:bg-neutral-600 rounded-full h-2">
                    <div className="bg-gradient-to-r from-accent-500 to-accent-600 h-2 rounded-full" style={{ width: '88%' }}></div>
                  </div>
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-r from-secondary-500 to-secondary-600 rounded-full flex items-center justify-center shadow-lg"
              >
